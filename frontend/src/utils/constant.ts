...
export const BASE_API_URL = (process.env.BASE_API_URL as string) || 'http://127.0.0.1:8000';
...
export const EMAIL = 'ptarunikaindomiratama@gmail.com';
export const PHONE = '+6282321419003';
export const ADDRESS = 'Lagoon premium office lt.Ug unit 33,lagoon ave pekayon jaya, bekasi selatan kota bekasi jawa barat';
