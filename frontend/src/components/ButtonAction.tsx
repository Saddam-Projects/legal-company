...
const ButtonUpdate = ({ currentResource, onClick }: ButtonActionInterface) => {
  return (
    <Button onClick={(e) => onClick(e)} size={'sm'} className="px-2 py-4 rounded-lg border-1 dark:border-blue-hris dark:bg-transparent dark:text-white  text-dark hover:opacity-80 hover:bg-transparent">
      <div className="flex space-x-2">
...
const ButtonDelete = ({ currentResource, onClick }: ButtonActionInterface) => {
  return (
    <Button onClick={(e) => onClick(e)} size={'sm'} className="px-2 py-4 rounded-lg border-1 dark:border-yellow dark:bg-transparent dark:text-white  text-dark hover:opacity-80 hover:bg-transparent">
      <div className="flex space-x-2">
